...
% CFD options
OptionsCFD.graphics         = false;                         % turn off all matlab graphics and prompts (hide in background), when running on HPC
...
OptionsCFD.NumCFDIterations = 2;                            % number of iterations between mooring and CFD

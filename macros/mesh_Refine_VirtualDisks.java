// STAR-CCM+ macro: mesh_Refine_VirtualDisks.java
...
public class mesh_Refine_VirtualDisks extends StarMacro {
    ...
    // autoMeshOperation_1.getMeshers().setMeshersByNames(new StringVector(new String[] {"star.dualmesher.DualAutoMesher", "star.prismmesher.PrismAutoMesher"}));
      ...
      List<String>	textline 		= new ArrayList<String>();
        ...
        try {
            ...
            Logger.getLogger(mesh_Refine_VirtualDisks.class.getName()).log(Level.SEVERE, null, ex);
        } // end try

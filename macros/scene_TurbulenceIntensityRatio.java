// STAR-CCM+ macro: scene_TurbulenceIntensityRatio.java
...
public class scene_TurbulenceIntensityRatio extends StarMacro {
  ...
  private void execute0() {
    ...
    scene_0.setPresentationName("Turbulence_Intensity_Ratio");
    ...
    scalarDisplayer_0.getScalarDisplayQuantity().setRange(new DoubleVector(new double[] {0.9, 1.1}));
